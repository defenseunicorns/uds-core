...
type UDSPackageApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *StatusClassApplyConfiguration `json:"status,omitempty"`
}
...
func (b *UDSPackageApplyConfiguration) WithStatus(value *StatusClassApplyConfiguration) *UDSPackageApplyConfiguration {
	b.Status = value
	return b
}
