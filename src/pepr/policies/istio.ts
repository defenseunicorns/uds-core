...
import { KubernetesObject, V1Pod, V1PodSecurityContext } from "@kubernetes/client-node";
...
When(a.Pod)
  ...
  .Validate(request => {
    return validateRestrictIstioSidecarOverrides(request);
  });

export function validateRestrictIstioSidecarOverrides(request: PeprValidateRequest<a.Pod>) {
...
When(a.Pod)
  ...
  .Validate(request => {
    return validateRestrictIstioTrafficOverrides(request);
  });

export function validateRestrictIstioTrafficOverrides(request: PeprValidateRequest<V1Pod>) {
...
When(a.Pod)
  ...
  .Validate(request => {
    return validateRestrictIstioAmbientOverrides(request);
  });

export function validateRestrictIstioAmbientOverrides(
  request: PeprValidateRequest<KubernetesObject>,
) {
...
When(a.Pod)
  ...
  .Validate(request => {
    return validateRestrictIstioUser(request);
  });

export function validateRestrictIstioUser(request: PeprValidateRequest<a.Pod>) {
