...
export interface Sso {
   ...
   * roles according to the client's role scope mappings and linked client scopes. UDS Core
   * defaults this setting to true for backwards compatibility. Set this to false whenever
