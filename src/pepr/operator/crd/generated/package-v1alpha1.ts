...
export interface Kubevirt {
  /**
   * Enables KubeVirt workload support for this package. When true, uds-vm applies
   * the uds.dev/kubevirt-workload label to the namespace and propagates the private-registry secret
   */
  enabled?: boolean;
}
