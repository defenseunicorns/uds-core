...
export interface AllowedListenersNamespaces {
   ...
   * * Selector: ListenerSets in namespaces selected by the selector may be attached to this
   * Gateway.
...
export interface AllowedRoutes {
   ...
   * Support: Core
   */
  namespaces?: AllowedRoutesNamespaces;
}
 ...
 * Support: Core
 */
export interface AllowedRoutesNamespaces {
  /**
...
export interface Default {
   ...
   * The maximum depth of a certificate chain accepted in verification is Implementation
   * specific.
   *
   * Support: Core
   */
 ...
 * on the containing object.
 */
export interface PurpleCACertificateRef {
  /**
   * Group is the group of the referent. For example, "gateway.networking.k8s.io".
 ...
 * on the containing object.
 */
export interface FluffyCACertificateRef {
  /**
   * Group is the group of the referent. For example, "gateway.networking.k8s.io".
   * When set to the empty string, core API group is inferred.
   */
