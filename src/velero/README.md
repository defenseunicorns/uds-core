...
> [!NOTE]
> Additional configuration will be required to get CSI backed PVCs to be snapshotted. For more information on configuring CSI backed volumes, see https://docs.defenseunicorns.com/core/how-to-guides/backup--restore/enable-volume-snapshots-vsphere/
