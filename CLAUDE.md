...
When writing or editing documentation, apply the style rules in `.ai/docs/style-rules.md` and match the voice profile in `.ai/docs/voice-profile.md`. Use the quick checklist in style-rules.md as a final quality gate before delivering any docs changes.
