...
| `classificationBanner` Helm value                                                   | 1.10.0 ([#2851](https://github.com/defenseunicorns/uds-core/pull/2851)) | **Reason:** The value supports only one banner configuration.<br/>**Migration:** Move the configuration into the `classificationBanners` list.           | 2.0.0             |
