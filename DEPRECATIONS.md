...
| `classificationBanner` Helm value (`istio` chart)                                   | 1.10.0 ([#2851](https://github.com/defenseunicorns/uds-core/pull/2851)) | **Reason:** The value supports only one banner configuration.<br/>**Migration:** Move the configuration into the `classificationBanners` list.           | 2.0.0             |
| Omitted `sso[].fullScopeAllowed`                                                     | 1.11.0 ([#2873](https://github.com/defenseunicorns/uds-core/pull/2873)) | **Reason:** UDS Core will change the default to `false` to limit role scope and harden security.<br/>**Migration:** Set `sso[].fullScopeAllowed: true` explicitly to preserve the current behavior. | 2.0.0             |
| Default `misdirectedRequest.enabled: true` (`istio` chart)                          | 1.13.0 ([#2962](https://github.com/defenseunicorns/uds-core/pull/2962)) | **Reason:** The EnvoyFilter can cause client compatibility issues.<br/>**Migration:** Set `misdirectedRequest.enabled: true` explicitly to preserve the current behavior. | 2.0.0             |
