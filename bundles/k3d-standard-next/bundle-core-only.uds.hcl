...
# This bundle is used only by upgrade experiments. The target cluster already
# contains the k3d and init packages from the released bundle, so keeping them
# out of this definition avoids rebuilding the large k3d artifact.
...
metadata {
  name        = "k3d-core-upgrade-next"
  description = "A Core-only UDS CLI Next bundle for upgrade testing"
