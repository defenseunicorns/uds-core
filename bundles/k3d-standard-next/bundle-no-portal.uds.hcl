...
# This file mirrors bundle.uds.hcl without the Portal functional layer.
# Registry1 does not include Portal, but UDS CLI Next currently discovers a
# bundle definition from a canonical bundle.uds.hcl file in the bundle directory.
# The create task copies this file into a build staging directory as bundle.uds.hcl
# for no-Portal bundle creation. Keep package versions, values, and dependencies
# in sync with bundle.uds.hcl.
