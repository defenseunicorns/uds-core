...
## [1.13.0](https://github.com/defenseunicorns/uds-core/compare/v1.12.0...v1.13.0) (2026-09-11)
...
* allow setting pepr webhook annotations via zarf values ([#2886](https://github.com/defenseunicorns/uds-core/issues/2886)) ([a6eb6e5](https://github.com/defenseunicorns/uds-core/commit/a6eb6e5cd4235463bc535ee569e08efc2fbcb627))
...
* **CORE-671:** prevent checkpoint node IP restore race ([#2881](https://github.com/defenseunicorns/uds-core/issues/2881)) ([b529b53](https://github.com/defenseunicorns/uds-core/commit/b529b5312a4eacde9d47f73379cfe36de7f6789d))
* **istio:** gate gateway deployment on Pepr ambient readiness ([#2871](https://github.com/defenseunicorns/uds-core/issues/2871)) ([b6dfb04](https://github.com/defenseunicorns/uds-core/commit/b6dfb042fb56d1bdf1e79ea6d7812764b8a46bd9))
* keycloak pdb templating ([#2878](https://github.com/defenseunicorns/uds-core/issues/2878)) ([1dab805](https://github.com/defenseunicorns/uds-core/commit/1dab805d5ab723c019536fa7d4cc078aa6a8de6b))


### Miscellaneous

* add slack notification for CLI compatibility ([#2876](https://github.com/defenseunicorns/uds-core/issues/2876)) ([2e2affb](https://github.com/defenseunicorns/uds-core/commit/2e2affb93d5c2c09c548b8efe1b255637bd713b0))
* add uds core 1.11 release notes ([#2888](https://github.com/defenseunicorns/uds-core/issues/2888)) ([910a07a](https://github.com/defenseunicorns/uds-core/commit/910a07a65d1ad2dd33335a81034501a3b32b9df7))
* **deps:** update iac-support-deps ([#2846](https://github.com/defenseunicorns/uds-core/issues/2846)) ([68b4a68](https://github.com/defenseunicorns/uds-core/commit/68b4a68e8c0f540a3b2de4d78db596cca2d4104b))
* **deps:** update keycloak to v0.30.0 ([#2887](https://github.com/defenseunicorns/uds-core/issues/2887)) ([6ecd18c](https://github.com/defenseunicorns/uds-core/commit/6ecd18c5bf4f591b0f7c8620560172012d777e5b))
* **deps:** update keycloak to v26.7.1 ([#2869](https://github.com/defenseunicorns/uds-core/issues/2869)) ([031f318](https://github.com/defenseunicorns/uds-core/commit/031f3184c1aa4b08c3b4033ce1a3b0ea3647b2c2))
* **deps:** update loki ([#2848](https://github.com/defenseunicorns/uds-core/issues/2848)) ([67415bf](https://github.com/defenseunicorns/uds-core/commit/67415bfdb3381a5bac7dfc6e3b38fbea68d9645b))
* **deps:** update pepr to v2 ([#2865](https://github.com/defenseunicorns/uds-core/issues/2865)) ([f44d893](https://github.com/defenseunicorns/uds-core/commit/f44d893fe58f5b89a890e3376c9bb39494a25328))
...
* **deps:** update prometheus-stack ([#2872](https://github.com/defenseunicorns/uds-core/issues/2872)) ([5cc820d](https://github.com/defenseunicorns/uds-core/commit/5cc820dd2a20596656c9ef1ed94f8776e9e283c8))
* **deps:** update prometheus-stack ([#2875](https://github.com/defenseunicorns/uds-core/issues/2875)) ([b4d9bc0](https://github.com/defenseunicorns/uds-core/commit/b4d9bc0e649f5b2bc5438e970849b0bc5ab8c847))
* **deps:** update support-deps ([#2854](https://github.com/defenseunicorns/uds-core/issues/2854)) ([71a2cc7](https://github.com/defenseunicorns/uds-core/commit/71a2cc736491f346112ab5d4d6eb7ee4e6679d88))
* **docs:** clarify Authservice and native SSO guidance ([#2857](https://github.com/defenseunicorns/uds-core/issues/2857)) ([349cd24](https://github.com/defenseunicorns/uds-core/commit/349cd242a6e7691b9d242b0377af7c93043943ce))
* update public CA config ([#2885](https://github.com/defenseunicorns/uds-core/issues/2885)) ([1c8d8df](https://github.com/defenseunicorns/uds-core/commit/1c8d8df8dbcfdd034c4f72e0c09ae702c9481af1))
...
* classification banner tests for iac ([#2856](https://github.com/defenseunicorns/uds-core/issues/2856)) ([f57cd2c](https://github.com/defenseunicorns/uds-core/commit/f57cd2c4dcd79081a7aaa16f5cc691e75d24a16d))
* classification banner working for SPAs ([#2710](https://github.com/defenseunicorns/uds-core/issues/2710)) ([367d25f](https://github.com/defenseunicorns/uds-core/commit/367d25f8a38386b6eb7bf4958991cd03c4bd43fc))
* pin pepr controller to temp registry1 image ([#2864](https://github.com/defenseunicorns/uds-core/issues/2864)) ([fef8054](https://github.com/defenseunicorns/uds-core/commit/fef8054c80bd4aae56a016f6f61fd666597feb8c))
* remove preview features from keycloak startup ([#2838](https://github.com/defenseunicorns/uds-core/issues/2838)) ([6bf2508](https://github.com/defenseunicorns/uds-core/commit/6bf2508547784dd78251a1f9497285892fc16992))
* uds-portal svg icon fix ([#2853](https://github.com/defenseunicorns/uds-core/issues/2853)) ([0f53171](https://github.com/defenseunicorns/uds-core/commit/0f531710578022c41929e0a685035aed5b1a664d))
...
* changing lula workflow to manual dispatch ([#2837](https://github.com/defenseunicorns/uds-core/issues/2837)) ([25277bc](https://github.com/defenseunicorns/uds-core/commit/25277bcb9546c6438f524f705385c2bc15fafb89))
* **ci:** update uptime tests to include uds-portal ([#2813](https://github.com/defenseunicorns/uds-core/issues/2813)) ([e0dc187](https://github.com/defenseunicorns/uds-core/commit/e0dc187fbd1fb90a73d60130bc222abd64ae6a70))
...
* **deps-dev:** bump fast-uri from 3.1.4 to 3.1.5 ([#2862](https://github.com/defenseunicorns/uds-core/issues/2862)) ([4d6ee7b](https://github.com/defenseunicorns/uds-core/commit/4d6ee7b7709321193aa4ae5f0243fd4af7824df0))
* **deps-dev:** bump ip-address from 10.2.0 to 10.4.0 in /test/vitest ([#2858](https://github.com/defenseunicorns/uds-core/issues/2858)) ([8259bb4](https://github.com/defenseunicorns/uds-core/commit/8259bb4e6a6c9e16f439b7f023472f30e93e62f0))
* **deps-dev:** bump js-yaml from 5.2.1 to 5.2.2 in /scripts/root-ca-retriever ([#2842](https://github.com/defenseunicorns/uds-core/issues/2842)) ([f9e3c7f](https://github.com/defenseunicorns/uds-core/commit/f9e3c7fbca595dcb0ae4005f33eefe9dcf198325))
* **deps-dev:** bump postcss from 8.5.15 to 8.5.23 in /test/vitest ([#2843](https://github.com/defenseunicorns/uds-core/issues/2843)) ([2ef1c78](https://github.com/defenseunicorns/uds-core/commit/2ef1c78b7d8d3a6906fb16c815192c4f76f22611))
* **deps-dev:** bump postcss from 8.5.22 to 8.5.25 in /scripts/root-ca-retriever ([#2861](https://github.com/defenseunicorns/uds-core/issues/2861)) ([0f8910e](https://github.com/defenseunicorns/uds-core/commit/0f8910ea78d1c09abad299b972ff14766207c18a))
...
* **deps:** bump brace-expansion ([#2863](https://github.com/defenseunicorns/uds-core/issues/2863)) ([af63c40](https://github.com/defenseunicorns/uds-core/commit/af63c40a94993515071ebd7232bd89bae02a36c5))
...
* **deps:** update authservice to v1.1.8 ([#2731](https://github.com/defenseunicorns/uds-core/issues/2731)) ([5204577](https://github.com/defenseunicorns/uds-core/commit/52045770f10c10d18a8f1713ab83b3bfba52557f))
* **deps:** update envoy-gateway ([#2804](https://github.com/defenseunicorns/uds-core/issues/2804)) ([baac8fd](https://github.com/defenseunicorns/uds-core/commit/baac8fd389d6f30751b3e77752c1d908d80b48da))
...
* **deps:** update iac-support-deps ([#2840](https://github.com/defenseunicorns/uds-core/issues/2840)) ([329ade0](https://github.com/defenseunicorns/uds-core/commit/329ade01852f9e570d31cb7b19d9979152938c17))
* **deps:** update loki ([#2825](https://github.com/defenseunicorns/uds-core/issues/2825)) ([79618b3](https://github.com/defenseunicorns/uds-core/commit/79618b346f3800344eba2dd9fbec85bee8e1fb8d))
* **deps:** update loki ([#2841](https://github.com/defenseunicorns/uds-core/issues/2841)) ([7168faf](https://github.com/defenseunicorns/uds-core/commit/7168faf2819d7dbc5de1c97487c7798dc4085049))
* **deps:** update pepr to v1.3.0 ([#2828](https://github.com/defenseunicorns/uds-core/issues/2828)) ([9f9da21](https://github.com/defenseunicorns/uds-core/commit/9f9da21e69b665096f31f3e5ac4b9612f7b16193))
* **deps:** update prometheus-stack ([#2810](https://github.com/defenseunicorns/uds-core/issues/2810)) ([3c3cb20](https://github.com/defenseunicorns/uds-core/commit/3c3cb2010cd32b4271135c482e6fec4597c02eb3))
* **docs:** updated 1.10 release notes to capture full scope ([#2866](https://github.com/defenseunicorns/uds-core/issues/2866)) ([c3ea8cc](https://github.com/defenseunicorns/uds-core/commit/c3ea8cc9271fe11d84b4d816cb716fb779385748))
* publish latest tag ([#2855](https://github.com/defenseunicorns/uds-core/issues/2855)) ([e6e7467](https://github.com/defenseunicorns/uds-core/commit/e6e746783019ba657c39a3fbbda01861e0eba311))
* refactor agent guidance ([#2845](https://github.com/defenseunicorns/uds-core/issues/2845)) ([e00b912](https://github.com/defenseunicorns/uds-core/commit/e00b9127e6cfb992398041ef487316fbf80e6ca9))
* replace deprecated pepr format with eslint and prettier ([#2796](https://github.com/defenseunicorns/uds-core/issues/2796)) ([9cadae2](https://github.com/defenseunicorns/uds-core/commit/9cadae2bc9182ed3cd167e9bc25b2f7ce93b040d))


### Documentation

* add brew tap trust ([#2860](https://github.com/defenseunicorns/uds-core/issues/2860)) ([60db0dd](https://github.com/defenseunicorns/uds-core/commit/60db0dddc074341f941689014799f47271844e66))
* add code of conduct ([#2847](https://github.com/defenseunicorns/uds-core/issues/2847)) ([303cfa7](https://github.com/defenseunicorns/uds-core/commit/303cfa7a989e43d09ca4d2f524f589774cda2631))
...
* add Envoy Gateway Component ([#2685](https://github.com/defenseunicorns/uds-core/issues/2685)) ([d941ce4](https://github.com/defenseunicorns/uds-core/commit/d941ce4c9be59b2c06260f74217cde7520319700))
* package CR expose annotations ([#2757](https://github.com/defenseunicorns/uds-core/issues/2757)) ([e052f68](https://github.com/defenseunicorns/uds-core/commit/e052f68900e9367ac5771eaacea91eec17558624))


### Miscellaneous

* **deps-dev:** bump form-data from 4.0.4 to 4.0.6 in /test/vitest ([#2754](https://github.com/defenseunicorns/uds-core/issues/2754)) ([ac0b221](https://github.com/defenseunicorns/uds-core/commit/ac0b2217e444ef5dfeaef4c4da60465529df7974))
* **deps-dev:** bump vite from 8.0.14 to 8.0.16 in /docs/.c4 ([#2749](https://github.com/defenseunicorns/uds-core/issues/2749)) ([5ece4e1](https://github.com/defenseunicorns/uds-core/commit/5ece4e1928881144e49ca278112207b95c80674f))
* **deps-dev:** bump vite from 8.0.5 to 8.0.16 in /scripts/renovate ([#2747](https://github.com/defenseunicorns/uds-core/issues/2747)) ([277d4b1](https://github.com/defenseunicorns/uds-core/commit/277d4b1690d6ba8e1df58a7e6ca5044ece15f9c0))
* **deps-dev:** bump vite from 8.0.5 to 8.0.16 in /test/vitest ([#2748](https://github.com/defenseunicorns/uds-core/issues/2748)) ([44e2318](https://github.com/defenseunicorns/uds-core/commit/44e2318b0135066bb848dab99a05f56efdda1650))
* **deps:** update falco ([#2643](https://github.com/defenseunicorns/uds-core/issues/2643)) ([2e86b30](https://github.com/defenseunicorns/uds-core/commit/2e86b30d2c8afd1069476f59ba04664e48e9cf7d))
* **deps:** update falco ([#2764](https://github.com/defenseunicorns/uds-core/issues/2764)) ([6bb6054](https://github.com/defenseunicorns/uds-core/commit/6bb6054966be6ce747f87c980df18c32d7ddfc40))
* **deps:** update iac-support-deps ([#2735](https://github.com/defenseunicorns/uds-core/issues/2735)) ([2dc173a](https://github.com/defenseunicorns/uds-core/commit/2dc173ab45a3b3d866604f2a1156f481e16f53bc))
* **deps:** update iac-support-deps ([#2756](https://github.com/defenseunicorns/uds-core/issues/2756)) ([7bb9449](https://github.com/defenseunicorns/uds-core/commit/7bb944952aac00f67892725d5b44bd9af6d75312))
* **deps:** update loki ([#2726](https://github.com/defenseunicorns/uds-core/issues/2726)) ([30fd38e](https://github.com/defenseunicorns/uds-core/commit/30fd38eeda7392512f061c582b3841e979becda0))
* **deps:** update prometheus-stack ([#2718](https://github.com/defenseunicorns/uds-core/issues/2718)) ([3205255](https://github.com/defenseunicorns/uds-core/commit/320525592cfcd5f93b0d7d9a1712b5bcf5848c0c))
* **deps:** update support-deps ([#2728](https://github.com/defenseunicorns/uds-core/issues/2728)) ([8c78383](https://github.com/defenseunicorns/uds-core/commit/8c78383d45e95c69945783845cf49d10b5539925))
* **deps:** update support-deps ([#2759](https://github.com/defenseunicorns/uds-core/issues/2759)) ([95fef9b](https://github.com/defenseunicorns/uds-core/commit/95fef9b2a9e8fc677b45b09a5183d3b35c3fe004))
* migrate the remaining package guidance to the new docs page ([#2730](https://github.com/defenseunicorns/uds-core/issues/2730)) ([b6ebeea](https://github.com/defenseunicorns/uds-core/commit/b6ebeea7dd120b40459af201939057702d0ff97c))
* **renovate:** group envoy-gateway updates ([#2742](https://github.com/defenseunicorns/uds-core/issues/2742)) ([f76bf35](https://github.com/defenseunicorns/uds-core/commit/f76bf35f4aedc3d5b657b1e9cd62719e495af934))
* uds-core v1.7.0 release notes ([#2765](https://github.com/defenseunicorns/uds-core/issues/2765)) ([316372d](https://github.com/defenseunicorns/uds-core/commit/316372d0fe5ced768ea27ca5207ce72741373088))


### Documentation

* fix for callout formatting ([#2763](https://github.com/defenseunicorns/uds-core/issues/2763)) ([6339826](https://github.com/defenseunicorns/uds-core/commit/6339826c6ec9ba1bf1a5d9b9e58e1c8dee4cc74d))
...
* broken grafana tests ([#2696](https://github.com/defenseunicorns/uds-core/issues/2696)) ([202c8ac](https://github.com/defenseunicorns/uds-core/commit/202c8acfee8c678957c9ebce77fcee37ec395cb8))
...
* add 1.5.0 release notes ([#2700](https://github.com/defenseunicorns/uds-core/issues/2700)) ([197dc46](https://github.com/defenseunicorns/uds-core/commit/197dc46b093a44c119ec7f434f557b718d588442))
...
* add TCP and UDP support to remoteProtocol on Allow entries ([#2641](https://github.com/defenseunicorns/uds-core/issues/2641)) ([ea32261](https://github.com/defenseunicorns/uds-core/commit/ea32261b24ac23cb950de57176758ee623d04b5a))
* **CORE-518:** disable dynamic client registration - release notes ([#2628](https://github.com/defenseunicorns/uds-core/issues/2628)) ([8f3ca19](https://github.com/defenseunicorns/uds-core/commit/8f3ca192baf83ae4d3bc0d7db4b8e1097ec10b2e))
* support enabling proxy protocol v2 for istio gateways ([#2660](https://github.com/defenseunicorns/uds-core/issues/2660)) ([5b95740](https://github.com/defenseunicorns/uds-core/commit/5b95740a1691cd458133950f5c0d41f7e27b197c))


### Bug Fixes

* ensure prometheus operator can manage endpoints for migration to slices ([#2646](https://github.com/defenseunicorns/uds-core/issues/2646)) ([0473379](https://github.com/defenseunicorns/uds-core/commit/04733798e59f40e3c988b81a7e58488558f91c38))


### Miscellaneous

* add 1.4.0 release notes ([#2665](https://github.com/defenseunicorns/uds-core/issues/2665)) ([877873d](https://github.com/defenseunicorns/uds-core/commit/877873d725dbf8b843f0ba7169837749ad139dea))
...
* **deps-dev:** bump ip-address from 10.0.1 to 10.2.0 in /test/vitest ([#2652](https://github.com/defenseunicorns/uds-core/issues/2652)) ([c18c77e](https://github.com/defenseunicorns/uds-core/commit/c18c77ea4d5706cf07450a3a3ed05485ac0be058))
* **deps-dev:** bump postcss from 8.5.8 to 8.5.14 in /scripts/root-ca-retriever ([#2653](https://github.com/defenseunicorns/uds-core/issues/2653)) ([0cd3298](https://github.com/defenseunicorns/uds-core/commit/0cd3298b918c6b06d52b1397850c63f6cfc4a3fa))
* **deps-dev:** bump postcss from 8.5.8 to 8.5.14 in /test/vitest ([#2638](https://github.com/defenseunicorns/uds-core/issues/2638)) ([c34ad18](https://github.com/defenseunicorns/uds-core/commit/c34ad18a7936d39cc3897e481db4994e493610a1))
* **deps:** bump picomatch from 2.3.1 to 2.3.2 in /docs/.c4 ([#2657](https://github.com/defenseunicorns/uds-core/issues/2657)) ([562ef69](https://github.com/defenseunicorns/uds-core/commit/562ef6998a9ebeb9f38bc726cbebc5c5a1e19ab2))
...
* **deps:** update iac support dependencies to v3.3.0 ([#2663](https://github.com/defenseunicorns/uds-core/issues/2663)) ([723759c](https://github.com/defenseunicorns/uds-core/commit/723759c2c28e0ba9ef41a5bfb2ef39fcee80e5a5))
* **deps:** update iac-support-deps ([#2562](https://github.com/defenseunicorns/uds-core/issues/2562)) ([0be2557](https://github.com/defenseunicorns/uds-core/commit/0be2557d667824d33c6d544fdad77efa9c4c2d6b))
* **deps:** update keycloak to v0.27.0 ([#2654](https://github.com/defenseunicorns/uds-core/issues/2654)) ([288a737](https://github.com/defenseunicorns/uds-core/commit/288a73708269f6b2f3d1cd97658199896694cc99))
* **deps:** update keycloak to v26.6.1 ([#2581](https://github.com/defenseunicorns/uds-core/issues/2581)) ([8fc7447](https://github.com/defenseunicorns/uds-core/commit/8fc744707a012fd11b7371e67711da946fbd32ae))
* **deps:** update pepr to v1.2.0 ([#2662](https://github.com/defenseunicorns/uds-core/issues/2662)) ([6d8eabd](https://github.com/defenseunicorns/uds-core/commit/6d8eabd5a96a093e726d9cb295db73380790050e))
...
* **deps:** update support-deps ([#2639](https://github.com/defenseunicorns/uds-core/issues/2639)) ([fee9493](https://github.com/defenseunicorns/uds-core/commit/fee94935812937c0780195c33513f0e60c9a9623))
* **deps:** update support-deps ([#2658](https://github.com/defenseunicorns/uds-core/issues/2658)) ([d419e36](https://github.com/defenseunicorns/uds-core/commit/d419e360f8b7d66476a19d5298881eb0844b170c))
* **deps:** update support-deps ([#2661](https://github.com/defenseunicorns/uds-core/issues/2661)) ([e6f0f36](https://github.com/defenseunicorns/uds-core/commit/e6f0f36fea1dfe3edb41f5870e1869f1ea807cb7))
* **deps:** update vector to 0.55.0 ([#2608](https://github.com/defenseunicorns/uds-core/issues/2608)) ([95bf222](https://github.com/defenseunicorns/uds-core/commit/95bf222ee1ff55d73dd410e01ce1e5808d02be0a))
* **deps:** update velero to v12.0.1 ([#2635](https://github.com/defenseunicorns/uds-core/issues/2635)) ([57e086f](https://github.com/defenseunicorns/uds-core/commit/57e086f76e13bab57ead07c7514bce804cf15940))
...
* add patch 1.3.1 to release notes ([#2649](https://github.com/defenseunicorns/uds-core/issues/2649)) ([2eb9763](https://github.com/defenseunicorns/uds-core/commit/2eb9763ba13fc1f084a686449275a974830d93e9))
* clarity on 1.3 release notes ([#2655](https://github.com/defenseunicorns/uds-core/issues/2655)) ([bddd4d6](https://github.com/defenseunicorns/uds-core/commit/bddd4d66ba45f633dda42d8ec12640e5cbc712c2))
...
* **CORE-27:** allow opt-in public clients ([#2598](https://github.com/defenseunicorns/uds-core/issues/2598)) ([9af5ca7](https://github.com/defenseunicorns/uds-core/commit/9af5ca78105bf142af7b6d1b37b56fcdf3f6176b))
* cycle gateways when istio gatewayTopology proxyProtocol changes ([#2595](https://github.com/defenseunicorns/uds-core/issues/2595)) ([5eceba7](https://github.com/defenseunicorns/uds-core/commit/5eceba793225bd16b052890bae856f82f2100412))


### Bug Fixes

* **ci:** run istio gen-crds in autogenerated-check ([#2605](https://github.com/defenseunicorns/uds-core/issues/2605)) ([40a1a97](https://github.com/defenseunicorns/uds-core/commit/40a1a97bf2e58afa1654923d4475678963c5ad1e))
* handle apply properly for keycloak client secret ([#2627](https://github.com/defenseunicorns/uds-core/issues/2627)) ([c227289](https://github.com/defenseunicorns/uds-core/commit/c22728906e17442ed0a99b6730240f90d133c7e4))
* re-add keycloak client registration authpol ([#2614](https://github.com/defenseunicorns/uds-core/issues/2614)) ([ebed871](https://github.com/defenseunicorns/uds-core/commit/ebed87173d4aa23b5e9f16834e7d20f3e7d0c8b9))
* restore original loki write service account name ([#2599](https://github.com/defenseunicorns/uds-core/issues/2599)) ([a5386e2](https://github.com/defenseunicorns/uds-core/commit/a5386e2583437d73f7979e5be5b78b0988e9a67c))
* updating prometheus to use endpointslice ([#2594](https://github.com/defenseunicorns/uds-core/issues/2594)) ([ba319c8](https://github.com/defenseunicorns/uds-core/commit/ba319c88f5db991082fc372c8c3ab8b5ace37452))


### Miscellaneous

* add retry to multi-arch manifest check ([#2602](https://github.com/defenseunicorns/uds-core/issues/2602)) ([4e8ba23](https://github.com/defenseunicorns/uds-core/commit/4e8ba231384f8ef2515d042674251bd85e5d9b5c))
* **deps-dev:** bump postcss from 8.5.8 to 8.5.12 in /scripts/renovate ([#2615](https://github.com/defenseunicorns/uds-core/issues/2615)) ([0922090](https://github.com/defenseunicorns/uds-core/commit/09220903ee9ccbb1e9460ba42611da4515b45d08))
* **deps:** update identity-config to 0.26.1 ([#2616](https://github.com/defenseunicorns/uds-core/issues/2616)) ([fd105a2](https://github.com/defenseunicorns/uds-core/commit/fd105a20f5d7e510be981e70f22b548005ba6101))
* **deps:** update istio to v1.29.2 ([#2587](https://github.com/defenseunicorns/uds-core/issues/2587)) ([caddf35](https://github.com/defenseunicorns/uds-core/commit/caddf35aeec405e0e7d9823c7188b3acb668714c))
* **deps:** update pepr to v1.1.6 ([#2607](https://github.com/defenseunicorns/uds-core/issues/2607)) ([d9f2ae9](https://github.com/defenseunicorns/uds-core/commit/d9f2ae9d3dd4fd700aecbaec91d217351c82a62b))
* **deps:** update pepr to v1.1.7 ([#2611](https://github.com/defenseunicorns/uds-core/issues/2611)) ([fd43cc3](https://github.com/defenseunicorns/uds-core/commit/fd43cc3b9a0c3f80feef8156f32750a32f13edbc))
* **deps:** update prometheus-stack ([#2546](https://github.com/defenseunicorns/uds-core/issues/2546)) ([6812697](https://github.com/defenseunicorns/uds-core/commit/681269713d5bde6f496614a42b0275f76e11e63a))
* **deps:** update velero chart to v12.0.1 ([#2613](https://github.com/defenseunicorns/uds-core/issues/2613)) ([1048ae9](https://github.com/defenseunicorns/uds-core/commit/1048ae99ac8cc0243a8a0d3b330d40c2f1b60490))
* swap bundles google idp saml signing cert ([#2609](https://github.com/defenseunicorns/uds-core/issues/2609)) ([57795b9](https://github.com/defenseunicorns/uds-core/commit/57795b9b5313fc4192362c55b676d4e88db29398))
* update istio CRDs to use v1 API ([#2606](https://github.com/defenseunicorns/uds-core/issues/2606)) ([079c361](https://github.com/defenseunicorns/uds-core/commit/079c3613783515fd7fd1dd2d1677cc9693a8d4e7))


### Documentation

* add 1.3.0 release notes ([#2633](https://github.com/defenseunicorns/uds-core/issues/2633)) ([00468ab](https://github.com/defenseunicorns/uds-core/commit/00468ab561a21b50d27a620fb995bad51bec6c5e))
* add keycloak admin handling doc ([#2597](https://github.com/defenseunicorns/uds-core/issues/2597)) ([328d19c](https://github.com/defenseunicorns/uds-core/commit/328d19c399c4702f2bfc5be9321e3147339c4e34))
* add troubleshooting for too many open files ([#2612](https://github.com/defenseunicorns/uds-core/issues/2612)) ([0b64a05](https://github.com/defenseunicorns/uds-core/commit/0b64a0543acd5876d0fa37b724c321d48353959e))
* update release notes for 1.2.1 ([#2603](https://github.com/defenseunicorns/uds-core/issues/2603)) ([bfa8124](https://github.com/defenseunicorns/uds-core/commit/bfa812406bae1ce0e73112e8a8ef1832109791bf))
* update release notes to include newest patches ([#2629](https://github.com/defenseunicorns/uds-core/issues/2629)) ([d59ca81](https://github.com/defenseunicorns/uds-core/commit/d59ca8140275bb27a67b09412d0087efbdcef1ae))
...
* add default endpoint probe and TLS expiry alerts ([#2530](https://github.com/defenseunicorns/uds-core/issues/2530)) ([625527c](https://github.com/defenseunicorns/uds-core/commit/625527c17f53fcf9da2aab7c5eb9095cfd1fbfbf))
* add support for image volumes in policy ([#2552](https://github.com/defenseunicorns/uds-core/issues/2552)) ([46b653e](https://github.com/defenseunicorns/uds-core/commit/46b653e77004ae5718e8eeadd40e22c07693bee5))
* default uptime probe overrides ([#2520](https://github.com/defenseunicorns/uds-core/issues/2520)) ([0c80295](https://github.com/defenseunicorns/uds-core/commit/0c80295055e78c217238bd05bf3d4415cf21bbdc))


### Bug Fixes

* **docs:** llm friendly docs ([#2535](https://github.com/defenseunicorns/uds-core/issues/2535)) ([107f181](https://github.com/defenseunicorns/uds-core/commit/107f181edbf7c7e0100c41471db7e56d0f6d6845))
* remove aggressive whitespace trimming in keycloak statefulset template ([#2539](https://github.com/defenseunicorns/uds-core/issues/2539)) ([231fa5c](https://github.com/defenseunicorns/uds-core/commit/231fa5cf6b9c0c1e06a9c43b0dcaa56d624d7c1c))


### Miscellaneous

* **ci:** cleanup old cve workflow ([#2550](https://github.com/defenseunicorns/uds-core/issues/2550)) ([f67afa8](https://github.com/defenseunicorns/uds-core/commit/f67afa84b2d1c028f4f1debb6be43f35c2dba211))
* **ci:** ensure concurrency on all workflows ([#2527](https://github.com/defenseunicorns/uds-core/issues/2527)) ([3ccf9ef](https://github.com/defenseunicorns/uds-core/commit/3ccf9ef8458024116d1fd9c89652c7afa99cd079))
* **deps-dev:** bump picomatch from 4.0.3 to 4.0.4 in /scripts/renovate ([#2538](https://github.com/defenseunicorns/uds-core/issues/2538)) ([ba0ed10](https://github.com/defenseunicorns/uds-core/commit/ba0ed10623f9a15c422684b7c2dee0520e2411d8))
* **deps-dev:** bump picomatch from 4.0.3 to 4.0.4 in /scripts/root-ca-retriever ([#2537](https://github.com/defenseunicorns/uds-core/issues/2537)) ([7bfaaa0](https://github.com/defenseunicorns/uds-core/commit/7bfaaa0e1f839157abcfd1a26fc57994bdb27746))
* **deps-dev:** bump rollup from 4.57.1 to 4.60.1 in /docs/.c4 ([#2551](https://github.com/defenseunicorns/uds-core/issues/2551)) ([abcb422](https://github.com/defenseunicorns/uds-core/commit/abcb422537acfa4385926a9724cc850a464b604a))
* **deps:** bump brace-expansion ([#2544](https://github.com/defenseunicorns/uds-core/issues/2544)) ([9cdc76e](https://github.com/defenseunicorns/uds-core/commit/9cdc76ea3e7ecf1bda57c33610ede8ca386b8b8d))
* **deps:** bump flatted from 3.4.1 to 3.4.2 ([#2512](https://github.com/defenseunicorns/uds-core/issues/2512)) ([7c08658](https://github.com/defenseunicorns/uds-core/commit/7c08658627655c2dc4dbd091c2b9ca5cb802ecef))
* **deps:** bump picomatch ([#2536](https://github.com/defenseunicorns/uds-core/issues/2536)) ([38baaa8](https://github.com/defenseunicorns/uds-core/commit/38baaa8609a9c037491eb10c4acd3cb6c02516ae))
* **deps:** bump yaml from 2.8.2 to 2.8.3 in /scripts/renovate ([#2542](https://github.com/defenseunicorns/uds-core/issues/2542)) ([f78b6df](https://github.com/defenseunicorns/uds-core/commit/f78b6df50fd755eb00fda343bdba6d9868b758f9))
* **deps:** update iac-support-deps ([#2534](https://github.com/defenseunicorns/uds-core/issues/2534)) ([5098a93](https://github.com/defenseunicorns/uds-core/commit/5098a939c7d04d1f920d6c9d10733d59fa66b0a9))
* **deps:** update keycloak to v26.5.6 ([#2502](https://github.com/defenseunicorns/uds-core/issues/2502)) ([ba6a2c0](https://github.com/defenseunicorns/uds-core/commit/ba6a2c0fadf6b0e3f7adcb3c8afc1b4339091134))
* **deps:** update pepr to v1.1.5 ([#2540](https://github.com/defenseunicorns/uds-core/issues/2540)) ([21bc575](https://github.com/defenseunicorns/uds-core/commit/21bc5757db69ad8f82f81f589b488dbd2992a9c4))
* **deps:** update prometheus-stack ([#2518](https://github.com/defenseunicorns/uds-core/issues/2518)) ([c9dfd05](https://github.com/defenseunicorns/uds-core/commit/c9dfd05b2b394677c7c351c8121381d23ed78fc6))
* **deps:** update setup-uv (support dep) to v8 ([#2548](https://github.com/defenseunicorns/uds-core/issues/2548)) ([2b55d1c](https://github.com/defenseunicorns/uds-core/commit/2b55d1c370f3ea0b32c12d26a1115299e1f2f942))
* **deps:** update support dependencies to v4.35.1 ([#2545](https://github.com/defenseunicorns/uds-core/issues/2545)) ([a964617](https://github.com/defenseunicorns/uds-core/commit/a96461757efb1e47b039a194e31119e789513599))
* **deps:** update UDS CLI to 0.30.0, Zarf init to 0.74.0 ([#2526](https://github.com/defenseunicorns/uds-core/issues/2526)) ([bb0fed5](https://github.com/defenseunicorns/uds-core/commit/bb0fed5e8daa9a16655422d164325b391b4b54b5))
* **deps:** update velero ([#2405](https://github.com/defenseunicorns/uds-core/issues/2405)) ([609947e](https://github.com/defenseunicorns/uds-core/commit/609947e9d8ed9842d941d45bd7b222d6a4f89f41))
* **docs:** add release notes for 1.1.0 ([#2555](https://github.com/defenseunicorns/uds-core/issues/2555)) ([3cc107e](https://github.com/defenseunicorns/uds-core/commit/3cc107e833c6325c5447bfb4f1384a8a70b8c9b2))
* **docs:** remove old doc images and diagrams ([#2521](https://github.com/defenseunicorns/uds-core/issues/2521)) ([7ef96c8](https://github.com/defenseunicorns/uds-core/commit/7ef96c87e53b35bfe39af8991d383d1f80c18093))
* **renovate:** add minimumReleaseAge for npm support dependencies ([#2553](https://github.com/defenseunicorns/uds-core/issues/2553)) ([94ff4d6](https://github.com/defenseunicorns/uds-core/commit/94ff4d6c43786401527a6015de1b41654923a92b))
* **renovate:** set min release age for pepr to null ([#2554](https://github.com/defenseunicorns/uds-core/issues/2554)) ([ee5dbf0](https://github.com/defenseunicorns/uds-core/commit/ee5dbf0af73a6e2faf1c256663b04d0aac326f1c))
* replace use of `uds` with `./uds` in uds tasks ([#2541](https://github.com/defenseunicorns/uds-core/issues/2541)) ([d165ec6](https://github.com/defenseunicorns/uds-core/commit/d165ec6916ad090265119837a1a14801e8d7f80b))
* update contributing doc link in PR template ([#2532](https://github.com/defenseunicorns/uds-core/issues/2532)) ([0651180](https://github.com/defenseunicorns/uds-core/commit/0651180a2e5b70768412307434530b5c5e7a8505))


### Documentation

* cleanup old doc sites references;cleanup readme ([#2525](https://github.com/defenseunicorns/uds-core/issues/2525)) ([c980914](https://github.com/defenseunicorns/uds-core/commit/c9809148caa6c3c46412c294279395314aba0813))
* fix incorrect link to configuration overview on reference overview ([#2533](https://github.com/defenseunicorns/uds-core/issues/2533)) ([32fe181](https://github.com/defenseunicorns/uds-core/commit/32fe18175809b28cec69e489c90d8a1a62713396))
* loki storage configuration reference ([#2529](https://github.com/defenseunicorns/uds-core/issues/2529)) ([25bd0e7](https://github.com/defenseunicorns/uds-core/commit/25bd0e78568e6c738c14d7881d89644e950deb38))

## [1.0.0](https://github.com/defenseunicorns/uds-core/compare/v0.63.0...v1.0.0) (2026-03-23)
...
* add keycloak realm display name customization ([#2479](https://github.com/defenseunicorns/uds-core/issues/2479)) ([10aa771](https://github.com/defenseunicorns/uds-core/commit/10aa77161c26b06e1073311c79a0fb84b3cac466))


### Bug Fixes

* **ci:** handle flaky behavior around policy test and probe check ([#2519](https://github.com/defenseunicorns/uds-core/issues/2519)) ([f2bc6a1](https://github.com/defenseunicorns/uds-core/commit/f2bc6a1d530cae9579f252a8395981582edebdfa))
* incr loki backend replicas to 3 in upgrade test ([ba33b49](https://github.com/defenseunicorns/uds-core/commit/ba33b493713b9bf014df99376466da97c7bbf5ab))
* **lint:** enforce strict equality and add regression guard lint rules ([#2411](https://github.com/defenseunicorns/uds-core/issues/2411)) ([880c748](https://github.com/defenseunicorns/uds-core/commit/880c7485c2470b26e0dc63cb68912dcbb017fb9f))
* reject network.allow rules without a remote ([#2510](https://github.com/defenseunicorns/uds-core/issues/2510)) ([0ef9d41](https://github.com/defenseunicorns/uds-core/commit/0ef9d4136668e5ee8176019c88dd0c560321cfcc))


### Miscellaneous

* add polling/increase timeout to prometheus target e2e test ([#2452](https://github.com/defenseunicorns/uds-core/issues/2452)) ([c6f11d4](https://github.com/defenseunicorns/uds-core/commit/c6f11d41bb45a6490ac4bcf079e5aca7c4c5ead5))
* bump loki helm chart to 6.57.0 ([ba33b49](https://github.com/defenseunicorns/uds-core/commit/ba33b493713b9bf014df99376466da97c7bbf5ab))
* cleanup deprecations table so it renders better on docs site ([#2506](https://github.com/defenseunicorns/uds-core/issues/2506)) ([0db9fc5](https://github.com/defenseunicorns/uds-core/commit/0db9fc55d97eaf8e2e1c567d69e184d9284e5476))
* correct the category annotation to 'dev.uds.categories' ([#2454](https://github.com/defenseunicorns/uds-core/issues/2454)) ([48c05d6](https://github.com/defenseunicorns/uds-core/commit/48c05d66135fa07081c62472e16bf26d865cfebb))
* **deps-dev:** bump undici from 7.16.0 to 7.24.1 in /test/vitest ([#2469](https://github.com/defenseunicorns/uds-core/issues/2469)) ([a192d0e](https://github.com/defenseunicorns/uds-core/commit/a192d0ec2e7fd240192f1bd5b8f42bf365bc4453))
* **deps:** align identity-authorization terminology ([#2482](https://github.com/defenseunicorns/uds-core/issues/2482)) ([5698329](https://github.com/defenseunicorns/uds-core/commit/56983294b3c4695d31b9166f50ce4dfd182c744f))
* **deps:** bump flatted from 3.3.3 to 3.4.1 ([#2472](https://github.com/defenseunicorns/uds-core/issues/2472)) ([5e65aa1](https://github.com/defenseunicorns/uds-core/commit/5e65aa158e6f5a6924c0554c7bf3852f7865bfad))
* **deps:** bump undici from 7.20.0 to 7.24.4 ([#2475](https://github.com/defenseunicorns/uds-core/issues/2475)) ([6635b2e](https://github.com/defenseunicorns/uds-core/commit/6635b2e775d9636b3729478564ce7f52c9b37582))
* **deps:** update grafana from 12.4.0 to 12.4.1 ([#2443](https://github.com/defenseunicorns/uds-core/issues/2443)) ([bba40a4](https://github.com/defenseunicorns/uds-core/commit/bba40a446cd74069657877f4f9c29c348b944943))
* **deps:** update iac-support-deps ([#2464](https://github.com/defenseunicorns/uds-core/issues/2464)) ([c14d667](https://github.com/defenseunicorns/uds-core/commit/c14d6673453e3f4ec66293c6f7e684811df6a7be))
* **deps:** update iac-support-deps ([#2481](https://github.com/defenseunicorns/uds-core/issues/2481)) ([efdac7b](https://github.com/defenseunicorns/uds-core/commit/efdac7bd8d88ead48f1c9ed822f8cd5bca761c73))
* **deps:** update identity-config from 0.24.0 to 0.25.0 ([#2514](https://github.com/defenseunicorns/uds-core/issues/2514)) ([607ec5a](https://github.com/defenseunicorns/uds-core/commit/607ec5a93456b7757407c8edb377a5fd5d119794))
* **deps:** update istio from 1.28.3 to 1.29.1 ([#2387](https://github.com/defenseunicorns/uds-core/issues/2387)) ([db05c8f](https://github.com/defenseunicorns/uds-core/commit/db05c8f9a099a2e0a7fe4d07092025deac0cfc74))
* **deps:** update loki (memcached 1.6.41, nginx 1.29.6) ([#2441](https://github.com/defenseunicorns/uds-core/issues/2441)) ([0625f8b](https://github.com/defenseunicorns/uds-core/commit/0625f8bdae6aab87b0a81363d80404d199ad446a))
* **deps:** update pepr from 1.1.2 to 1.1.4 ([#2484](https://github.com/defenseunicorns/uds-core/issues/2484)) ([4cb5cdd](https://github.com/defenseunicorns/uds-core/commit/4cb5cdda131d706089d00eefd39521c6775b73e4))
* **deps:** update prometheus-stack ([#2420](https://github.com/defenseunicorns/uds-core/issues/2420)) ([5041496](https://github.com/defenseunicorns/uds-core/commit/5041496798488d890b43aaf092447bffac3a5757))
* **deps:** update prometheus-stack ([#2474](https://github.com/defenseunicorns/uds-core/issues/2474)) ([e2abba4](https://github.com/defenseunicorns/uds-core/commit/e2abba4eff4bc08b78fc9211ca480b88c3a67356))
* **deps:** update support-deps ([#2450](https://github.com/defenseunicorns/uds-core/issues/2450)) ([84e409f](https://github.com/defenseunicorns/uds-core/commit/84e409f57ae4ce4490b1c86327064fb6c3b18e2e))
* **deps:** update vector to 0.54.0 ([#2451](https://github.com/defenseunicorns/uds-core/issues/2451)) ([5fc8bac](https://github.com/defenseunicorns/uds-core/commit/5fc8baca6391f732d5549116f321055885f7bff9))
* **docs:** add backup restore how to guides ([#2456](https://github.com/defenseunicorns/uds-core/issues/2456)) ([6f785a2](https://github.com/defenseunicorns/uds-core/commit/6f785a2fcf78b4e38a1cdc2fdaf09ac5ffa0dd8f))
* **docs:** add compliance callout ([#2497](https://github.com/defenseunicorns/uds-core/issues/2497)) ([68a77e5](https://github.com/defenseunicorns/uds-core/commit/68a77e5a34515f55e1026e80d456b08361a81065))
* **docs:** add docs on functional layers ([#2501](https://github.com/defenseunicorns/uds-core/issues/2501)) ([f3fbda9](https://github.com/defenseunicorns/uds-core/commit/f3fbda9c5cdc5ba0939bdc2bbb603c19a00ea911))
* **docs:** add docs.config.json file ([#2473](https://github.com/defenseunicorns/uds-core/issues/2473)) ([fc4f9f5](https://github.com/defenseunicorns/uds-core/commit/fc4f9f5cc1d6bfe1bf10e561c52b57aeecf71a19))
* **docs:** add how to guides for additional core packages ([#2491](https://github.com/defenseunicorns/uds-core/issues/2491)) ([170f12f](https://github.com/defenseunicorns/uds-core/commit/170f12ff812c68470bee9b9ec44c4e31a350d8f1))
* **docs:** add how-to guides for monitoring to new docs site ([#2445](https://github.com/defenseunicorns/uds-core/issues/2445)) ([44e0c46](https://github.com/defenseunicorns/uds-core/commit/44e0c463cd8e7784afe5be6b6b431c90c5c2c152))
* **docs:** add keycloak notifications and alerts how to guide ([#2516](https://github.com/defenseunicorns/uds-core/issues/2516)) ([6c405b9](https://github.com/defenseunicorns/uds-core/commit/6c405b97558c47577f5c8855412f89de2855beae))
* **docs:** add likec4 diagram ([#2500](https://github.com/defenseunicorns/uds-core/issues/2500)) ([a08e63c](https://github.com/defenseunicorns/uds-core/commit/a08e63ce838d9a4ec364a27f3f7879044e3534ae))
* **docs:** add new how-to docs for logging ([#2453](https://github.com/defenseunicorns/uds-core/issues/2453)) ([f18ac93](https://github.com/defenseunicorns/uds-core/commit/f18ac93eb695a6da68ed9fa07057f44fde9812af))
* **docs:** add platform features how-to docs ([#2460](https://github.com/defenseunicorns/uds-core/issues/2460)) ([bd66bce](https://github.com/defenseunicorns/uds-core/commit/bd66bce0f52e19897edcd0b45e304a04b18f6340))
* **docs:** add troubleshooting/runbooks section to new docs site ([#2449](https://github.com/defenseunicorns/uds-core/issues/2449)) ([8ffced3](https://github.com/defenseunicorns/uds-core/commit/8ffced34ae4316064c0e7f7a1c6ab8729db91e88))
* **docs:** add uds packaging docs ([#2457](https://github.com/defenseunicorns/uds-core/issues/2457)) ([6e92672](https://github.com/defenseunicorns/uds-core/commit/6e9267297355dd63dbe1379bb3c61f3e9dc487bf))
* **docs:** add versioning/release concept doc to new site ([#2495](https://github.com/defenseunicorns/uds-core/issues/2495)) ([0bed16c](https://github.com/defenseunicorns/uds-core/commit/0bed16c6b386e58e05c06e367c0bb9281e52e587))
* **docs:** add voice/style profile for docs writing and update docs ([#2509](https://github.com/defenseunicorns/uds-core/issues/2509)) ([630fa16](https://github.com/defenseunicorns/uds-core/commit/630fa16d9c4c3a910628f3378cb82eb10d7debb7))
* **docs:** address documentation feedback and cleanup ([#2493](https://github.com/defenseunicorns/uds-core/issues/2493)) ([4bb2736](https://github.com/defenseunicorns/uds-core/commit/4bb2736d64eb49b57ee55e5912f296027683cdf0))
* **docs:** cleanup promql and logql code blocks ([#2477](https://github.com/defenseunicorns/uds-core/issues/2477)) ([65a961d](https://github.com/defenseunicorns/uds-core/commit/65a961d2438bbdb1c005ff33ccc97c1e2feb20d5))
* **docs:** cleanup reference docs for operator CRDs on new site ([#2467](https://github.com/defenseunicorns/uds-core/issues/2467)) ([e437538](https://github.com/defenseunicorns/uds-core/commit/e4375380bc53db3d67ea384edd06ef61bd606897))
* **docs:** enable pagination override for getting started docs ([#2463](https://github.com/defenseunicorns/uds-core/issues/2463)) ([bf1c9bc](https://github.com/defenseunicorns/uds-core/commit/bf1c9bce26ebcea072e83584206d44ab8183b9c3))
* **docs:** fix overview paths ([#2462](https://github.com/defenseunicorns/uds-core/issues/2462)) ([6dd3ad8](https://github.com/defenseunicorns/uds-core/commit/6dd3ad817a58ce38716c2be04a497512b8524d71))
* **docs:** identity-access how to guides ([#2437](https://github.com/defenseunicorns/uds-core/issues/2437)) ([74f1d39](https://github.com/defenseunicorns/uds-core/commit/74f1d3952a3529c12326c9988508580a89fa39ca))
* **docs:** reference section part 2 ([#2465](https://github.com/defenseunicorns/uds-core/issues/2465)) ([0249240](https://github.com/defenseunicorns/uds-core/commit/024924097d0413d95f545e5f9023ddf917a4d040))
* **docs:** remove css from index.mdx file ([#2499](https://github.com/defenseunicorns/uds-core/issues/2499)) ([1263b5e](https://github.com/defenseunicorns/uds-core/commit/1263b5e097f02f29b7df7a517520e1ad2a5b202b))
* **docs:** runtime-security how to guides ([#2448](https://github.com/defenseunicorns/uds-core/issues/2448)) ([88b6662](https://github.com/defenseunicorns/uds-core/commit/88b6662960f05ece044599cf8dab98ef98a16045))
* **docs:** update doc dir naming ([#2522](https://github.com/defenseunicorns/uds-core/issues/2522)) ([33be9b3](https://github.com/defenseunicorns/uds-core/commit/33be9b31feafa14495116cb115c0803ed5048856))
* **docs:** update monitoring ha guide with prometheus sizing ([#2468](https://github.com/defenseunicorns/uds-core/issues/2468)) ([2c7f183](https://github.com/defenseunicorns/uds-core/commit/2c7f1839796d900a17ec305657b44eede70f0d39))
* **docs:** update to create landing page ([#2476](https://github.com/defenseunicorns/uds-core/issues/2476)) ([e780443](https://github.com/defenseunicorns/uds-core/commit/e78044305e671f2863b1727d1aabc5cfeac8b9f5))
* **docs:** use registry references in new doc site instead of ghcr ([#2496](https://github.com/defenseunicorns/uds-core/issues/2496)) ([509206b](https://github.com/defenseunicorns/uds-core/commit/509206b5d596564de785c048c9454f7345330432))
* fix dev-docs local script ([#2488](https://github.com/defenseunicorns/uds-core/issues/2488)) ([793cf1a](https://github.com/defenseunicorns/uds-core/commit/793cf1a9c7099c9a9dbc553d3c645a9b419e76a7))
* incr loki backend/read/write replicas to 3 in ha upgrade test ([ba33b49](https://github.com/defenseunicorns/uds-core/commit/ba33b493713b9bf014df99376466da97c7bbf5ab))
* remove deprecated CA_CERT variable ([#2489](https://github.com/defenseunicorns/uds-core/issues/2489)) ([ffdfc48](https://github.com/defenseunicorns/uds-core/commit/ffdfc480a3f2c1f55583929cd4b197d8cde45aae))
* remove deprecated operator config CIDR values ([#2494](https://github.com/defenseunicorns/uds-core/issues/2494)) ([e290cdc](https://github.com/defenseunicorns/uds-core/commit/e290cdcea850c0c770335dafecadb055c1993bf7))
* remove keycloak FIPS switch ([#2483](https://github.com/defenseunicorns/uds-core/issues/2483)) ([f5b63d0](https://github.com/defenseunicorns/uds-core/commit/f5b63d0472e33b132677d24c15eba23ae5f4be56))
* remove x509LookupProvider and mtlsClientCert from KC values ([#2486](https://github.com/defenseunicorns/uds-core/issues/2486)) ([9496bfe](https://github.com/defenseunicorns/uds-core/commit/9496bfe9f48e80b3d7eb8099120d98979c26fd11))
* replace accredit with authorize in docs ([#2507](https://github.com/defenseunicorns/uds-core/issues/2507)) ([f3f4072](https://github.com/defenseunicorns/uds-core/commit/f3f40729533b972a700f3702bc2e6ba161c10719))
* switch loki helm chart to grafana-community chart ([ba33b49](https://github.com/defenseunicorns/uds-core/commit/ba33b493713b9bf014df99376466da97c7bbf5ab))
* update dev-docs to align with cli ([#2498](https://github.com/defenseunicorns/uds-core/issues/2498)) ([30074c7](https://github.com/defenseunicorns/uds-core/commit/30074c70df1d70f62edacaa420d97eb2fcc42970))
* update public ca config to exclude new root ([#2511](https://github.com/defenseunicorns/uds-core/issues/2511)) ([139940e](https://github.com/defenseunicorns/uds-core/commit/139940e0a4e68127caec81158efabae4d1f0ca9f))


### Documentation

* add documentation on resizing prometheus volumes ([#2440](https://github.com/defenseunicorns/uds-core/issues/2440)) ([bd54266](https://github.com/defenseunicorns/uds-core/commit/bd54266576b9608099ac85e3cdd05243d59117c4))
* add guide link ([#2471](https://github.com/defenseunicorns/uds-core/issues/2471)) ([df47223](https://github.com/defenseunicorns/uds-core/commit/df47223df32e77cd1f65de868c635bb8ac13cbf4))
* add how-tos for policy/compliance ([#2461](https://github.com/defenseunicorns/uds-core/issues/2461)) ([2b9a33f](https://github.com/defenseunicorns/uds-core/commit/2b9a33fb6dfef4ec63ab3d31cbb2138261c70c3b))
* add release notes for 1.0 ([#2515](https://github.com/defenseunicorns/uds-core/issues/2515)) ([f4903da](https://github.com/defenseunicorns/uds-core/commit/f4903da346ba42bf46c38ab3349f6f0caaaa8847))
* clean up 1.0 release notes page ([#2523](https://github.com/defenseunicorns/uds-core/issues/2523)) ([9eff8fd](https://github.com/defenseunicorns/uds-core/commit/9eff8fd7678a6db8e47423acf7887b3e23e327c5))
* fix concepts titles and delete stub ([#2508](https://github.com/defenseunicorns/uds-core/issues/2508)) ([cc94720](https://github.com/defenseunicorns/uds-core/commit/cc94720fd2fa8d71bbbe550cad9f47369eaa8b5c))
* fix policy engine reference page ([#2504](https://github.com/defenseunicorns/uds-core/issues/2504)) ([2c92bf9](https://github.com/defenseunicorns/uds-core/commit/2c92bf93a63a7d7675be3487640914fa5318b8c4))
* how-to guide fixes and updated guidance ([#2466](https://github.com/defenseunicorns/uds-core/issues/2466)) ([2e78ee6](https://github.com/defenseunicorns/uds-core/commit/2e78ee69859bd8055430d02a18e3edcdfb596090))
* operations and maintenance - upgrades and configuration changes ([#2487](https://github.com/defenseunicorns/uds-core/issues/2487)) ([59178ba](https://github.com/defenseunicorns/uds-core/commit/59178ba6068ca8bd40eb3fd48914e8ac1c371106))
* update deprecation table for Package deprecations ([#2492](https://github.com/defenseunicorns/uds-core/issues/2492)) ([c583f96](https://github.com/defenseunicorns/uds-core/commit/c583f96f515e54f9e968e9461a8c98eec7a5c632))
* update dev-docs task to handle core subdir ([#2480](https://github.com/defenseunicorns/uds-core/issues/2480)) ([b36398f](https://github.com/defenseunicorns/uds-core/commit/b36398f872173c7707785b8baf7593d13c67d4e3))
* update network docs, add trust management ([#2459](https://github.com/defenseunicorns/uds-core/issues/2459)) ([940fc64](https://github.com/defenseunicorns/uds-core/commit/940fc64c9553e93d8cfc2292595cc59992cacf1e))

## [0.63.0](https://github.com/defenseunicorns/uds-core/compare/v0.62.0...v0.63.0) (2026-03-10)


### Features

* core uptime recording rules and dashboard ([#2426](https://github.com/defenseunicorns/uds-core/issues/2426)) ([86bce57](https://github.com/defenseunicorns/uds-core/commit/86bce57774b7f6540db79ac7d3d2f5d020361179))
* release standalone crd layer for pre-core exemptions ([#2429](https://github.com/defenseunicorns/uds-core/issues/2429)) ([e294808](https://github.com/defenseunicorns/uds-core/commit/e2948084fd0eea504543240658c6d1a3c72ac4e1))
...
* add getting-started new docs ([#2422](https://github.com/defenseunicorns/uds-core/issues/2422)) ([4d49b70](https://github.com/defenseunicorns/uds-core/commit/4d49b70cf35564c4e55024d545a55b1c4b0c9fdb))
...
* **ci:** split lightweight setup-tools action from setup action ([#2430](https://github.com/defenseunicorns/uds-core/issues/2430)) ([ec27289](https://github.com/defenseunicorns/uds-core/commit/ec27289e3eab00619938aa680368d722949c1ad1))
* **deps-dev:** bump rollup from 4.52.5 to 4.59.0 in /test/vitest ([#2417](https://github.com/defenseunicorns/uds-core/issues/2417)) ([2cf6ea0](https://github.com/defenseunicorns/uds-core/commit/2cf6ea0a4547f37a72c79cbcb6f6f61cceccc9cb))
* **deps-dev:** bump rollup from 4.53.2 to 4.59.0 in /scripts/root-ca-retriever ([#2436](https://github.com/defenseunicorns/uds-core/issues/2436)) ([ff33062](https://github.com/defenseunicorns/uds-core/commit/ff33062374d707925582e72ecf6ec20b1bb7ddde))
...
* **deps:** bump rollup from 4.56.0 to 4.59.0 ([#2424](https://github.com/defenseunicorns/uds-core/issues/2424)) ([0c3e01b](https://github.com/defenseunicorns/uds-core/commit/0c3e01b57e9698bcc6ca34d5ba6e1b8ccd5f8d1a))
* **deps:** update grafana to v12.4.0 ([#2406](https://github.com/defenseunicorns/uds-core/issues/2406)) ([62a31fe](https://github.com/defenseunicorns/uds-core/commit/62a31fe41c10dda1cd511619fbd00a547af7305a))
* **deps:** update iac-support-deps ([#2408](https://github.com/defenseunicorns/uds-core/issues/2408)) ([e5844db](https://github.com/defenseunicorns/uds-core/commit/e5844db175806bd04373a6141346585612e5e7c9))
...
* **deps:** update keycloak to v26.5.5 ([#2447](https://github.com/defenseunicorns/uds-core/issues/2447)) ([8d0db59](https://github.com/defenseunicorns/uds-core/commit/8d0db59ecec60dc1b684ac6b2848f42524e33c24))
...
* **deps:** update pepr to v1.1.2 ([#2401](https://github.com/defenseunicorns/uds-core/issues/2401)) ([da1c7a2](https://github.com/defenseunicorns/uds-core/commit/da1c7a272a181f08db33ef2782375f5efa3e1491))
...
* **deps:** update support-deps ([#2403](https://github.com/defenseunicorns/uds-core/issues/2403)) ([0007490](https://github.com/defenseunicorns/uds-core/commit/0007490fed70315f38907783c0d35f773b4d1754))
* **deps:** update support-deps ([#2425](https://github.com/defenseunicorns/uds-core/issues/2425)) ([747b15e](https://github.com/defenseunicorns/uds-core/commit/747b15e7e228323acc8da41b4e812a3d695af97a))
* **deps:** update support-deps ([#2435](https://github.com/defenseunicorns/uds-core/issues/2435)) ([8b99827](https://github.com/defenseunicorns/uds-core/commit/8b9982790f0729068d5207a4b8f8c9e7e9db80a5))
* **deps:** update uds-identity-config v0.24.0 ([#2439](https://github.com/defenseunicorns/uds-core/issues/2439)) ([bc43c44](https://github.com/defenseunicorns/uds-core/commit/bc43c44aca0f5606e831713d908befc031ea3c3b))
* **docs:** add concepts/configuration-and-packaging to new docs site ([#2431](https://github.com/defenseunicorns/uds-core/issues/2431)) ([88cf7cc](https://github.com/defenseunicorns/uds-core/commit/88cf7ccead9f23613c19dd0a433582a2efb890dd))
* **docs:** add concepts/platform section to new docs site ([#2427](https://github.com/defenseunicorns/uds-core/issues/2427)) ([ddf8333](https://github.com/defenseunicorns/uds-core/commit/ddf83330a1deefa40ee2a0d2f01867162b32afb2))
* **docs:** add how-to guides for ha/resources on new docs site ([#2433](https://github.com/defenseunicorns/uds-core/issues/2433)) ([0fa60cb](https://github.com/defenseunicorns/uds-core/commit/0fa60cb7a5f57b3be5e96eeaecd7a37a49bf26cc))
* **docs:** add uds-core concepts section to docs site ([#2423](https://github.com/defenseunicorns/uds-core/issues/2423)) ([e52cc84](https://github.com/defenseunicorns/uds-core/commit/e52cc84d8e1d3001dfd0199f88d1708a7ac72a8a))
* **docs:** document airgapped certificate revocation check process ([#2404](https://github.com/defenseunicorns/uds-core/issues/2404)) ([b2c8aa6](https://github.com/defenseunicorns/uds-core/commit/b2c8aa6cd62c6330b6c9f2abc2b78c9c8ea9e4c6))
* update DoD ca certs ([#2438](https://github.com/defenseunicorns/uds-core/issues/2438)) ([19a9c7e](https://github.com/defenseunicorns/uds-core/commit/19a9c7e0c84183d58f18f510ff87964efe5e6fc9))
* update to grafana 11.3.0 chart, community repo ([#2444](https://github.com/defenseunicorns/uds-core/issues/2444)) ([9dbaeca](https://github.com/defenseunicorns/uds-core/commit/9dbaeca561fc77b28c4babc7e52bd3d04d1088db))


### Documentation

* add networking guides ([#2434](https://github.com/defenseunicorns/uds-core/issues/2434)) ([36d7297](https://github.com/defenseunicorns/uds-core/commit/36d72976bbab15112eafde0ea49957d12c39b299))
