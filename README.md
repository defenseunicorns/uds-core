...
- [UDS CLI](https://github.com/defenseunicorns/uds-cli?tab=readme-ov-file#install): v0.27.13 or later
...
```bash
uds deploy k3d-core-demo:0.52.1
```
...
```bash
uds deploy k3d-core-slim-dev:0.52.1
```
