...
The example below uses AWS S3. For other providers (Azure, GCP), the override structure and credentials format will differ — see [Velero's supported providers](https://velero.io/docs/main/supported-providers/#s3-compatible-object-store-providers) for provider-specific configuration.
...
<CardGrid>
  ...
  <LinkCard
    title="Deploy →"
    href="/getting-started/production/deploy/"
  />
</CardGrid>
