...
UDS Core provides a shared platform layer — networking, identity, observability, security, and backup — so application teams can focus on mission logic rather than infrastructure plumbing. This page clarifies the ownership boundary between the two layers. See our [interactive architecture diagram](/concepts/overview/#how-uds-core-is-structured) for a visual overview.
