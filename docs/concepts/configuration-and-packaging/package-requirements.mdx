...
> [!TIP]
> Use this page as a pre-publish checklist. For step-by-step guidance on building a package that meets these requirements, see [Package an Existing Helm Chart](/how-to-guides/packaging-applications/package-existing-helm-chart/).
...
<CardGrid>
  <LinkCard
    ...
    description="Step-by-step guide to building a package that meets these requirements."
    href="/how-to-guides/packaging-applications/package-existing-helm-chart/"
  />
  <LinkCard
    title="Package testing"
    description="Set up the journey and upgrade tests required by these standards."
    href="/how-to-guides/packaging-applications/package-testing/"
  />
  <LinkCard
    title="Networking & service mesh"
    description="How UDS Core enforces network policies and service mesh rules your package must declare."
    href="/concepts/core-features/networking/"
  />
  <LinkCard
    title="Identity & authentication"
    description="How Keycloak client registration and SSO integration work — required for any package with user login."
    href="/concepts/core-features/identity-access/"
  />
  <LinkCard
    title="Policy & compliance"
    description="How Pepr validates and mutates workloads — what gets blocked and how exemptions work."
