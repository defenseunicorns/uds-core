...
- **MUST** include application metadata for UDS Registry publishing. See [Package Metadata](/how-to-guides/packaging-applications/package-metadata/).
- **SHOULD** follow the [Package Values](/how-to-guides/packaging-applications/package-values/) guide for exposing package configuration.
