...
<LinkCard title="Package CR Reference" href="/reference/operator-and-crds/package/" description="Full schema, fields, and YAML examples." />
...
An Exemption CR is a **permission slip**. It names exactly which policies to bypass and targets specific workloads by namespace and name. It also supports title and description fields — so the reason for the exception can be documented right next to the exception itself.

<LinkCard title="Exemption CR Reference" href="/reference/operator-and-crds/exemption/" description="Full schema, fields, and YAML examples." />
...
<LinkCard title="ClusterConfig CR Reference" href="/reference/operator-and-crds/clusterconfig/" description="Full schema, fields, and YAML examples." />
