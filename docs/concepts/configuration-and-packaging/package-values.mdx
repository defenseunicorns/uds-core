...
The schema should follow [JSON Schema](https://json-schema.org/). Consider using `uds zarf dev generate-schema` to generate it from the package definition, chart values, and value mappings.
