...
- **Compliance** — regulated environments require documented, tested backup and recovery capabilities with defined [RPO and RTO](https://velero.io/docs/latest/disaster-case/) targets
