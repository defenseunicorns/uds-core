...
## Networking & Service Mesh in UDS Core
...
By default, gateways only support HTTP/HTTPS traffic. Non-HTTP TCP ingress (e.g., SSH) requires additional configuration — see [Configure ingress gateways](/how-to-guides/networking/configure-ingress-gateways/).
