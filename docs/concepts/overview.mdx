...
*Explore the interactive diagram below to see how UDS Core's components connect.*
...
- Sets up an operator-managed Authservice SSO flow to protect workloads at the Istio mesh boundary
