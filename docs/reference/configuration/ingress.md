...
![UDS Core Ingress / Egress](https://github.com/defenseunicorns/uds-core/blob/update-existing-diagrams/docs/.images/diagrams/uds-core-arch-ports-protocols.svg?raw=true)
