...
![UDS Core Architecture Diagram](https://github.com/defenseunicorns/uds-core/blob/update-existing-diagrams/docs/.images/diagrams/uds-core-arch-overview.svg?raw=true)
