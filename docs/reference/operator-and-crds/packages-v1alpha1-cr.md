...
<table style="width: 100%; table-layout: fixed;">
  ...
  <tbody>
    <tr><td style="white-space: nowrap;">podAnnotations</td><td style="white-space: nowrap;"></td><td>Additional annotations to apply to the generated ambient waypoint pod template</td></tr>
  </tbody>
</table>
</div>
