...
- Loki connected to external object storage — see [Configure HA logging](/how-to-guides/high-availability/logging/) for S3 setup
...
2. **Set per-stream retention rules (optional)**
