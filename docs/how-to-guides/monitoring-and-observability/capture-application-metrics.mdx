...
- [Add custom dashboards to Grafana](/how-to-guides/monitoring-and-observability/add-custom-dashboards/) - Build Grafana dashboards to visualize the metrics you're now collecting.
- [Create metric alerting rules](/how-to-guides/monitoring-and-observability/create-metric-alerting-rules/) - Define alerting conditions based on the metrics Prometheus is scraping.
