...
To trigger a manual backup for testing, see [Perform a manual backup](/how-to-guides/backup-and-restore/perform-backup/).
...
- [Configure Velero with IRSA on Amazon EKS](/how-to-guides/backup-and-restore/configure-velero-irsa/) - set up IRSA authentication on the Velero service account before enabling EBS snapshots.
