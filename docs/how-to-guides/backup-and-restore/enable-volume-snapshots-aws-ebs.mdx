...
- [Configure Velero with IRSA on AWS EKS](/how-to-guides/backup-and-restore/configure-velero-irsa/) - Set up IRSA authentication on the Velero service account before enabling EBS snapshots.
