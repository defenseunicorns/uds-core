...
1. **Configure your storage destination**
   ...
   <Tabs>
     <TabItem label="S3-compatible storage">
       ...
       > [!TIP]
       > For EKS deployments, consider using [IRSA (IAM Roles for Service Accounts)](/how-to-guides/backup-and-restore/configure-velero-irsa/) instead of static access keys. IRSA eliminates long-lived credentials from your cluster configuration and aligns with AWS IAM security recommendations.
