     ...
     <TabItem label="S3-compatible storage">
       ...
       <Tabs>
         ...
         <TabItem label="IRSA on Amazon EKS">
           ...
           For full configuration steps, including IAM policy and role setup, see [Configure Velero with IRSA on Amazon EKS](/how-to-guides/backup-and-restore/configure-velero-irsa/).
