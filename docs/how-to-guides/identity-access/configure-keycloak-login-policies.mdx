...
5. **Deploy your bundle**
   ...
   > [!NOTE]
   > To manage FIPS 140-2 mode (enabled by default), see [Manage FIPS 140-2 mode](/how-to-guides/identity-access/enable-fips-mode/).
...
- [Manage FIPS 140-2 mode](/how-to-guides/identity-access/enable-fips-mode/) — verify FIPS status, understand constraints, or disable FIPS if not required
