...
|---|---|---|
| **Helm chart values** (this guide) | Session policies, account settings, auth flow toggles | No |
...
5. **Deploy your bundle**
   ...
   > [!NOTE]
   > To run Keycloak in FIPS 140-2 strict mode, see [Enable FIPS 140-2 strict mode](/how-to-guides/identity-access/enable-fips-mode/).
...
- [Enable FIPS 140-2 strict mode](/how-to-guides/identity-access/enable-fips-mode/) — run Keycloak in FIPS-approved mode with Bouncy Castle FIPS JARs
