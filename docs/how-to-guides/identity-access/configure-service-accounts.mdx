...
- [Protect non-OIDC apps with SSO](/how-to-guides/identity-access/protect-apps-with-authservice/) — how to set up the Authservice-protected application that service accounts will access
