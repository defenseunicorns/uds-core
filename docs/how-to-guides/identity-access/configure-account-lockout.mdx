...
4. Log in to the Keycloak Admin Console → **Users** → select the test user → **Details** tab to view the locked status
...
- [Configure Keycloak authentication methods](/how-to-guides/identity-access/configure-authentication-flows/) — enable or disable authentication flows alongside lockout settings
