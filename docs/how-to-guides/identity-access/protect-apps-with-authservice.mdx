...
- [Configure PDB and affinity](/how-to-guides/high-availability/configure-pdb-and-affinity/) — scaling workloads for production resilience
...
<CardGrid>
  ...
  />
  <LinkCard
    title="Configure PDB and affinity"
    description="Set up pod disruption budgets and affinity rules for production resilience."
    href="/how-to-guides/high-availability/configure-pdb-and-affinity/"
  />
</CardGrid>
