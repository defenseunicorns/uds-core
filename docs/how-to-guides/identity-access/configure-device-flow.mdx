...
2. **Include the Package CR in your application's Zarf package**

   Add the `package.yaml` as a manifest in your application's `zarf.yaml`:
   ...
   Build and deploy the updated Zarf package through your UDS bundle as usual:
   ...
   > [!TIP]
   > For quick testing against an already-running cluster, you can apply the Package CR directly:
   > ```bash
