...
- UDS Core deployed
- Application deployed as a UDS Package with SSO and Authservice configured (see [Protect apps with Authservice](/how-to-guides/identity-access/protect-apps-with-authservice/))
...
- The user's group claim is not included in the SSO client's default scopes
...
- [Identity & Authentication concepts](/concepts/core-features/identity-access/) — background on platform groups and the SSO model
- [Package CR reference](/reference/operator-and-crds/package/) — full `groups` field specification
- [Protect apps with Authservice](/how-to-guides/identity-access/protect-apps-with-authservice/) — required prerequisite for group-based access on apps without native OIDC
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Map Azure groups to Keycloak groups for enterprise SSO."
