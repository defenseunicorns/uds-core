...
- [Configure automatic pod reload](/how-to-guides/platform-features/configure-pod-reload/) — Automatically restart pods when their Secrets or ConfigMaps change.
