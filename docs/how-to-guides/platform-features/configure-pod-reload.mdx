...
- [Enable the classification banner](/how-to-guides/platform-features/enable-classification-banner/) — Inject security classification markings into web UIs via Istio EnvoyFilter.
