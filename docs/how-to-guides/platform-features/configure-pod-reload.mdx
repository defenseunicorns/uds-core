...
- [Register and customize SSO clients](/how-to-guides/identity-and-authorization/register-and-customize-sso-clients/) — configure `secretConfig.labels` and `secretConfig.annotations` for SSO client secrets
...
<CardGrid>
  <LinkCard
    ...
    description="Inject security classification markings into web UIs via Istio EnvoyFilter."
