...
- [Connect Azure AD as an identity provider](/how-to-guides/identity-and-authorization/connect-azure-ad-idp/) — Federate Keycloak with Azure Entra ID for enterprise SSO.
