...
- [Connect Azure AD as an identity provider](/how-to-guides/identity-and-authorization/connect-azure-ad-idp/) — Map Azure groups to Keycloak groups for enterprise SSO.
