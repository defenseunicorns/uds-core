...
1. **Register the SSO client in a Package CR**
   ...
   Choose the protocol supported by your application. If your application supports both, [UDS package requirements](https://github.com/defenseunicorns/uds-common/blob/main/docs/uds-packages/requirements/uds-package-requirements.md) recommend considering SAML with SCIM as the more secure default.
