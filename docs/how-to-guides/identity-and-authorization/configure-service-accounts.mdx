...
> [!WARNING]
> `groups.anyOf` restrictions apply during interactive user authentication and do not restrict client-credentials callers. Authservice accepts service-account tokens based on their issuer and audience. If machine identities need separate authorization, enforce it with an application or mesh policy.
...
- [Protect applications with Authservice](/how-to-guides/identity-and-authorization/protect-apps-with-authservice/) - Configure operator-managed OIDC protection at the Istio mesh boundary.
