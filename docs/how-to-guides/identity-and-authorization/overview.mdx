...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/how-to-guides/identity-and-authorization/enable-fips-mode/"
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Enable built-in alerts for Keycloak realm, user, and admin changes via Loki recording rules and Prometheus."
