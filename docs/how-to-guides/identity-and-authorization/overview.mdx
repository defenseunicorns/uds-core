...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Enable the tenant gateway console, provision a UDS realm administrator, and manage UDS users."
    href="/how-to-guides/identity-and-authorization/use-dedicated-realm-admin-console/"
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Configure operator-managed OIDC protection at the Istio mesh boundary."
  ...
  <LinkCard
    ...
    description="Automatically disable non-admin accounts after a set number of days of inactivity to satisfy APSC-DV-000320."
