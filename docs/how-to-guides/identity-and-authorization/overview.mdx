...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Declare AD/LDAP user federation in Keycloak using HCL for infrastructure-as-code management."
    href="/how-to-guides/identity-and-authorization/configure-ad-ldap-user-federation-with-opentofu/"
  />
  <LinkCard
    title="Configure AD/LDAP user federation in Keycloak UI"
    description="Connect Active Directory or LDAP to Keycloak as a user federation provider so directory users can authenticate to UDS Core applications."
    href="/how-to-guides/identity-and-authorization/configure-ad-ldap-user-federation/"
  />
  <LinkCard
    title="Configure Kerberos/SPNEGO SSO"
    description="Enable transparent single sign-on for domain-joined clients using Kerberos tickets, with no username or password prompt."
    href="/how-to-guides/identity-and-authorization/configure-kerberos-spnego-sso/"
  />
</CardGrid>
