...
To confirm storage is working end-to-end, trigger a manual backup and verify it completes. See [Perform backup and restore](/how-to-guides/backup-restore/perform-backup-restore/).
