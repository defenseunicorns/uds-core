...
| [Incubating](https://falco.org/docs/reference/rules/default-rules/) | Disabled | Rules with broader coverage for more specific use cases; may generate noise in some environments |
