...
> [!TIP]
> On EKS, consider using [Configure Loki with IRSA on AWS EKS](/how-to-guides/high-availability/configure-loki-irsa/) instead of static credentials to connect Loki to S3. IRSA replaces long-lived access keys with temporary credentials injected by the EKS OIDC webhook.
