...
- [Monitoring & Observability reference](/reference/configuration/monitoring-observability/): Default probes, recording rules, and how to disable built-in uptime probes.
