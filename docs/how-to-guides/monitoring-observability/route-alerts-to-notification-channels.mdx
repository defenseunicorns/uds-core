...
- [Create metric alerting rules](/how-to-guides/monitoring-observability/create-metric-alerting-rules/) - Define the alerting conditions that Alertmanager will route.
- [Create log-based alerting and recording rules](/how-to-guides/monitoring-observability/create-log-based-alerting-and-recording-rules/) - Add log pattern detection alerts that also route through Alertmanager.
