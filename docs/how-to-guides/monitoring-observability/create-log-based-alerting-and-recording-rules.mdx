...
- [Route alerts to notification channels](/how-to-guides/monitoring-observability/route-alerts-to-notification-channels/) - Configure Alertmanager to deliver Loki alerts to Slack, PagerDuty, or email.
- [Create metric alerting rules](/how-to-guides/monitoring-observability/create-metric-alerting-rules/) - Define additional alerting conditions based on Prometheus metrics.
