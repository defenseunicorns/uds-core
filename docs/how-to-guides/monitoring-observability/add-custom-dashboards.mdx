...
- [Add Grafana datasources](/how-to-guides/monitoring-observability/add-grafana-datasources/) - Connect Grafana to additional data sources for your dashboards.
- [Capture application metrics](/how-to-guides/monitoring-observability/capture-application-metrics/) - Get your application's metrics into Prometheus so dashboards have data to display.
