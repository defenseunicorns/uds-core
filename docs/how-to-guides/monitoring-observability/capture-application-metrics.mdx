...
<CardGrid>
  <LinkCard
    ...
    description="Build Grafana dashboards to visualize the metrics you're now collecting."
    href="/how-to-guides/monitoring-observability/add-custom-dashboards/"
  />
  <LinkCard
    title="Create metric alerting rules"
    description="Define alerting conditions based on the metrics Prometheus is scraping."
