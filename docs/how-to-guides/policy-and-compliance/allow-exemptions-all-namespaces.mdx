...
> [!WARNING]
> Enabling all-namespace exemptions means any user with permission to create Exemption CRs in any namespace can bypass Pepr policies. Before enabling this, ensure your RBAC configuration restricts who can create, update, and delete Exemption resources. Without proper RBAC controls, this setting significantly increases the risk of unintended or unauthorized policy bypasses.
...
<CardGrid>
  <LinkCard
    ...
    description="Review exemptions across all namespaces for scope and justification."
