...
- [Configure TLS certificates](/how-to-guides/networking/configure-tls-certificates/) for details on certificate management
- [Set up non-HTTP ingress](/how-to-guides/networking/configure-non-http-ingress/) if your custom gateway needs TCP support
