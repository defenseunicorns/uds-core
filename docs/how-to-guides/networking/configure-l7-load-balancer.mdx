...
After completing this guide, UDS Core will work correctly behind an L7 load balancer such as AWS Application Load Balancer (ALB) or Azure Application Gateway. You will configure external TLS termination, trusted proxy settings, and optionally client certificate forwarding.
