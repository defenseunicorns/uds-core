...
- [Configure TLS certificates](/how-to-guides/networking/configure-tls-certificates/) for gateway certificate management
- [Expose applications on gateways](/how-to-guides/networking/expose-apps-on-gateways/) to set up application routing
