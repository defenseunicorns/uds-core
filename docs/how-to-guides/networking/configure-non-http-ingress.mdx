...
After completing this guide, your cluster will accept non-HTTP TCP traffic (such as SSH) through an Istio gateway, routed to your application service.
...
> [!NOTE]
> This guide covers TCP ingress through Istio. Istio itself does not support UDP ingress. For UDP traffic, see [Expose UDP applications](/how-to-guides/networking/expose-udp-apps/), which routes through Envoy Gateway instead.
...
- [Expose UDP applications](/how-to-guides/networking/expose-udp-apps/) - Route UDP traffic through Envoy Gateway instead of Istio.
