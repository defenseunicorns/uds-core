...
4. **Verify**
   ...
   ```bash
   kubectl get package my-tls-app -n my-tls-app
   ```
...
- [Expose applications on gateways](/how-to-guides/networking/expose-apps-on-gateways/) for standard TLS-terminated ingress
- [Create a custom gateway](/how-to-guides/networking/create-custom-gateways/) if you need more control over gateway configuration
