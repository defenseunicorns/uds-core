...
Path-based routing in this release applies to built-in Keycloak and Grafana routes. Other services continue to use domain and subdomain routing unless you define additional `Package` routing behavior.
