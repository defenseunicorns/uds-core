...
- UDS Core deployed to your cluster with TLS configured — see [Configure TLS certificates](/how-to-guides/networking/configure-tls-certificates/)
...
**Solution:**
- Verify the Package CR was reconciled: `kubectl get package my-app -n my-app` — check the `STATUS` column
...
- [Enable the passthrough gateway](/how-to-guides/networking/enable-passthrough-gateway/) for applications that handle their own TLS
- [Define network access](/how-to-guides/networking/define-network-access/) for intra-cluster traffic and external egress
- [Create a custom gateway](/how-to-guides/networking/create-custom-gateways/) for specialized security or domain requirements
