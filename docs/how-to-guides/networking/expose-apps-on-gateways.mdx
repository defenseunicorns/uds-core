...
- [Configure advanced HTTP routing](/how-to-guides/networking/configure-advanced-http-routing/) — add CORS policies, header manipulation, URI rewrites, redirects, and retries to your exposed services
