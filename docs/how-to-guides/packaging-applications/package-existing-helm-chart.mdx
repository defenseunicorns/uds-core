...
<CardGrid>
  ...
  />
  <LinkCard
    title="Validate package requirements"
    description="Check your package against production-readiness standards before publishing."
    href="/how-to-guides/packaging-applications/validate-package-requirements/"
  />
  <LinkCard
    title="Publish to the UDS registry"
    description="Build and publish your validated package."
    href="/how-to-guides/packaging-applications/publish-bundle-to-uds-registry/"
  />
  <LinkCard
