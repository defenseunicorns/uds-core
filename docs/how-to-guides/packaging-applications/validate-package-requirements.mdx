...
You'll validate that your UDS Package meets the production-readiness standards required for confident integration and operation. Use this checklist during development and before publishing to ensure your package is complete.

## Prerequisites

- [UDS CLI](https://github.com/defenseunicorns/uds-cli/releases) installed
- Access to a Kubernetes cluster with UDS Core deployed
- A UDS Package ready for validation
- Familiarity with the [UDS Package CR](/reference/operator-and-crds/packages-v1alpha1-cr/) and [bundle overrides](/concepts/configuration-and-packaging/bundles/)

## Before you begin

This page follows [RFC-2119](https://datatracker.ietf.org/doc/html/rfc2119) for requirement levels — **MUST** indicates a mandatory requirement, **SHOULD** a strong recommendation, and **MAY** an optional practice. Work through each section and check off items as your package meets them.

For the conceptual rationale behind these standards, see [Package Requirements](/concepts/configuration-and-packaging/package-requirements/).
...
> [!TIP]
> For step-by-step guidance on building a package that meets these requirements, see the [Packaging Applications](/how-to-guides/packaging-applications/overview/) how-to guides.
