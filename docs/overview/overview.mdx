...
<CardGrid>
  ...
  <Card title="UDS Registry" icon="star">
    ...
    starting point—browse available packages, inspect CVE reports, and pull artifacts directly into your bundles.

    <LinkCard title="UDS Registry" href="https://registry.defenseunicorns.com/" />
  </Card>

  <Card title="Open-Source Foundation" icon="open-book">
    UDS is built on Defense Unicorns' open-source projects:
...
<CardGrid>
  <LinkCard
    ...
    description="Deploy, configure, and maintain UDS Core in cloud, on-premises, or air-gapped environments. Start with Getting Started."
  ...
  <LinkCard
    ...
    description="Consuming a UDS-backed environment? Learn how the platform layer affects your workloads in Concepts."
