...
5. **Confirm your bundle configuration matches the desired volume size**

   Verify the size configured in your `uds-bundle.yaml` and/or `uds-config.yaml` matches your desired volume size.
