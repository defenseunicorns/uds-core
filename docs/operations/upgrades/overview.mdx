...
This guide covers the general procedures, checklists, and strategies for upgrading UDS Core. For version-specific breaking changes, notable features, and upgrade considerations, see the [Release Notes](/core/operations/release-notes/overview/).
...
3. **Review Keycloak upgrade steps**
   ...
   Check for Keycloak-specific migration steps in the release notes. Some UDS Core upgrades require manual Keycloak realm configuration changes. See [Upgrade Keycloak realm configuration](/core/operations/upgrades/upgrade-keycloak-realm/) for details.
...
For version-specific breaking changes, notable features, and upgrade considerations, see the [Release Notes](/core/operations/release-notes/overview/).
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/core/operations/upgrades/upgrade-keycloak-realm/"
  />
  <LinkCard
