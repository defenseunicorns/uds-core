...
> [!NOTE]
> This guide covers specific changes for the 0.59 to 0.60 upgrade. For general upgrade procedures, see the [Upgrade Overview](/core/operations/upgrades/overview/).
