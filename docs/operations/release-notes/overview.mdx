...
<LinkCard
  title="UDS Core 1.13"
  description="Configurable HTTP 421 misdirected-request protection and improved checkpoint restores, shared egress reconciliation, and startup safety."
  href="/operations/release-notes/1-13/"
/>
<LinkCard
  title="UDS Core 1.12"
