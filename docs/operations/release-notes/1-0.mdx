...
| Keycloak | 26.5.3 | [26.5.7](https://github.com/keycloak/keycloak/releases/tag/26.5.7) |
...
> [!IMPORTANT]
> Upgrade directly to v1.0.1 to pick up a Keycloak security fix. Keycloak 26.5.7 addresses vulnerabilities disclosed in the [Keycloak 26.5.7 release announcement](https://www.keycloak.org/2026/04/keycloak-2657-released). The bundle reference below targets v1.0.1.

```yaml title="uds-bundle.yaml"
packages:
  - name: core
    repository: registry.defenseunicorns.com/public/core
    # Upgrade to 1.0.1 (includes Keycloak 26.5.7 security fix)
    ref: 1.0.1-upstream
```
