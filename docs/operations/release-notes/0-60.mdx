...
This release upgrades UDS Identity Config to 0.23. No breaking changes are included.
...
> [!NOTE]
> Existing realms require manual client updates to enable logout confirmation. See [Upgrade Keycloak realm configuration](/core/operations/upgrades/upgrade-keycloak-realm/) for version-specific steps.
...
- [Full diff (0.59.0...0.60.0)](https://github.com/defenseunicorns/uds-core/compare/v0.59.0...v0.60.0) — all changes between versions
