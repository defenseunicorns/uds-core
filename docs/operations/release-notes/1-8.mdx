...
- **Fleet Command Keycloak client:** A new scoped `uds-fleet-admin` client lets Fleet Command authenticate to Keycloak. New installs get it automatically; existing clusters need the [manual realm changes](#manual-realm-changes-identity-config-0290) below ([#2734](https://github.com/defenseunicorns/uds-core/pull/2734)).
