...
- **Reset Password links:** Registered users who are locked out can now reset their password through the public SSO URL without disrupting Realm administration through the admin URL ([#2898](https://github.com/defenseunicorns/uds-core/pull/2898)).
