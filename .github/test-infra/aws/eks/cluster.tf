  ...
  eks_managed_node_groups = {
    main = {
      ...
      iam_role_additional_policies = {
        ...
        # Lets aws-network-policy-agent ship per-flow Accept/Deny verdicts to CloudWatch Logs
        # for CI triage. Required by nodeAgent.enableCloudWatchLogs in the vpc-cni addon below.
  ...
  addons = {
    vpc-cni = {
      ...
      configuration_values = jsonencode({
        ...
        # Stream per-flow Accept/Deny verdicts to CloudWatch Logs for CI triage.
