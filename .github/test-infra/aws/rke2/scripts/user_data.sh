...
# Temporary, disable resilient watch cache for testing
./yq -i '.kube-apiserver-arg += "feature-gates=ResilientWatchCacheInitialization=false"' /etc/rancher/rke2/config.yaml
